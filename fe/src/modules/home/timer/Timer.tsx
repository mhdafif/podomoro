...
const Timer = () => {
  ...
  return (
    <div className="flex flex-col items-center text-white">
      {/* Active Task Display */}
      {activeTask && (
        <div className="absolute top-0 right-0 mb-4 flex max-w-44 items-center gap-2 rounded-bl-lg border border-green-500/30 bg-green-600/20 px-4 py-2">
          <Target className="h-4 w-4 flex-shrink-0 text-green-400" />
